...
def duplicate_country(ti):
    ...
    # mess1 = {'_id': '1421263241991324092814',
    ...
    #
    # mess2 = {'_id': '232633661995370092814',
    ...
    # mess3 = {'_id': '822023861995374091814',
...
def test_tweets_daily_basis():
    dict1 = test_tweets_daily_basis_metadata()
...
start >> country_code >> [covid_keywords,
    ...
    total_tweets, tweets_daily_basis, top_preventions, trending_data, top_words, donation_coll,
    trend_data_daily] >> mid >> [test_total_tweets, test_tweets_daily_basis, test_top_100, test_donation] >> end
