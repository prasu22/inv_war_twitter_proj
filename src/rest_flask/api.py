...
from src.analytics.tweet_extracts import overall_tweet_per_country_in_last_n_month, \
    total_tweet_per_country_on_daily_basis, \
    top_100_words_tweeted_in_world, top_100_word_occuring_with_country, top_10_prevention, top_10_prevention_world_wide, \
    total_no_of_donations
from src.mongodb.mongo_data_connector import connect_with_collection_data
...
#
# @app.route('/top_100_words_all_countries')
#
# def top_100_words_all_countries():
#     try:
#         word_dict = top_100_word_all_countries()
#         return json.dumps(word_dict)
#     except Exception as e:
#         print("some error occured",e)
#         return {'error',e}
