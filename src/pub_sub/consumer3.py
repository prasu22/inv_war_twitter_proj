...
"""
print("after import in consumer3 ")
...
#
#
print("consumer satrt 3 outside",my_consumer)
def consumer_processing():
    list_tweet_info = []
    print("consumer satrt 3",my_consumer)
