...
from src.common.variable_files import COUNTRY_NAME_KEY ,COUNTRY_CODE_KEY ,DONATION_AMOUNT_KEY,CURRENCY_NAME_KEY,DONATION_KEYWORDS_KEY,COVID_KEYWORD_KEY,COUNT_KEY
