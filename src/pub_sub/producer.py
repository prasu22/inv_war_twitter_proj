...
#             "@COVID_DRUGS", "#donation #covid", "#WHO #covid", "#CDC #covid", "@WHO #covid", "@CDC #covid", "@Health #covid", "@mask #covid",
#             "#social distance #covid", "#impact #covid", "#stay safe #covid", "#vaccination #covid", "#wash hands #covid", "#sanitiser #covid", "#coronavirus",
#             "#precaution", "#prevention", "#vaccines", "@plasmahelp", "@DonationIND","#stock market #covid"]
