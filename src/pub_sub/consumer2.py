...
print("after import in consumer2 ")
"""
...
count = 0
print("consumer satrt 2outside",my_consumer)
#
#
def consumer_processing():
    list_tweet_info = []
    print("consumer satrt 2",my_consumer)
    ...
    for msg in my_consumer:
        ...
        try:
            if len(list_tweet_info) >= BATCH_SIZE:
                ...
                # now analytics start
                # print("updated mag", list_of_updated_msg)
