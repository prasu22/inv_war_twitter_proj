from common_variables.variable_files import COLL_OF_TOP_10_PREVENTIVE_WORDS

from common_variables.variable_files import COUNTRY_NAME_KEY ,COUNTRY_CODE_KEY ,PREVENTION_KEYWORDS_KEY ,WHO_KEYWORDS_KEY ,WORD_KEY,COUNT_KEY
