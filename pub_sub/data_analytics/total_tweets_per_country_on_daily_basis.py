...
from comman_variables.variable_files import COLL_OF_TWEET_PER_COUNTRY_ON_DAILY_BASIS

from comman_variables.variable_files import COUNTRY_NAME_KEY ,COUNTRY_CODE_KEY  ,CREATED_AT_KEY,COUNT_KEY
