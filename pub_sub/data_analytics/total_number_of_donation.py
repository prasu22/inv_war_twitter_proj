from comman_variables.variable_files import COLL_OF_DONATION_PER_COUNTRY
from comman_variables.variable_files import COUNTRY_NAME_KEY ,COUNTRY_CODE_KEY ,DONATION_AMOUNT_KEY,CURRENCY_NAME_KEY,DONATION_KEYWORDS_KEY,COVID_KEYWORD_KEY,COUNT_KEY
